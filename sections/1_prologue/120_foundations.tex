...
\begin{properdescription}
    ...
    Instead of using this term, we later later introduce the notion of \emph{delta-based} transformations, which operate on the actual changes, or deltas, performed in the source model.
\end{properdescription}
