...
Sequences are mathematically equal to tuples, but we write them differently to make explicitly that their order has a semantics and explicitly define the access operator for its contained elements.
