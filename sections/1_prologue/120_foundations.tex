...
\todo{Introduce sequences}
\todo{Introduce functions}
...
\todo{Derivate from set/tuple notation, when sets are contained in sets and so on, and when its clear from context.}
