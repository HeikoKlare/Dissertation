...
\begin{align*}
    &
    \tuple{v} \subseteq \tuple{w} \equivalentperdefinition \forall t' \in \tuple{v} : t' \in \tuple{w} \\
    &
    \tuple{v} \cap \tuple{w} := \setted{t' \mid t' \in \tuple{v} \land t' \in \tuple{w}}
\end{align*}
