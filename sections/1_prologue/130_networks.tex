...
Structural consistency can thus be checked without executing the model, comparable to the distinction between \emph{static} and \emph{dynamic} semantics of models, as introduced in \autoref{chap:foundations:modeling:models}.
...
\begin{figure}
    ...
    \label{fig:prologue:network:process_structure_behavior}
\end{figure}
...
We depict the proposed process in \autoref{fig:prologue:network:process_structure_behavior}.
