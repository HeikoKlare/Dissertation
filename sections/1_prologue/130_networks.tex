...
We have so far informally considered consistency as the absence of some kind of contradictions in different models.
...
While structural consistency relations do not consider execution semantics and will thus usually decidable, behavioral consistency relations will usually be undecidable, because as soon as we have Turing-complete descriptions of behavior, we cannot decide their semantic equivalence. %\todo{add cite?}
