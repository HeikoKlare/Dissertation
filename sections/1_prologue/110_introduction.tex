...
Tools describe their models in specific languages, for example denoted by \gls{XML} schemes. % or \acrlongpl{DSL}.
...
It is neither known how a developer can achieve a \emph{correct} transformation network specification, i.e., transformations and an orchestration of them that delivers consistent models when applied, nor how he or she can systematically improve quality properties of the network such as %\emph{reusability} and 
...
\begin{figure}
    ...
    \caption[Consistency relations for \acrshort{PCM} and \acrshort{UML}/Java]{Extract of consistency relations between component-based architectures in \gls{PCM} and object-oriented design in \gls{UML}/Java according to \textcite{langhammer2017a}. Relations are indicated by dashed blue lines. Properties are omitted, each element has a least a name.}
