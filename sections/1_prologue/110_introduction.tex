...
For example, a performance engineer may be concerned with an instance of the \gls{PCM} for an architecture-based prediction of the system's performance and knows how this description is reflected in the general software architecture described in the \gls{UML} as well the implementation in Java.
A software architect may use \gls{UML} models for the architecture specification and how they are related to the implementation.
...
Beispiel muss doppelte Spezifikation enthalten und auch die Begründung dafür (COTS, doppelt definiert, müssen wir mit klarkommen).
...
* Define the process and roles (either here or in properties chapter):
** Domain expert
