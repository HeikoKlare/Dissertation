...
\begin{figure}
    ...
    Transformations are defined by transformation developers and marked green, concrete systems and changes are runtime artifacts and marked blue, and the orchestration with a resulting transformation network as application artifacts are marked orange. The assumed and envisioned properties are denoted in red and italics.}
