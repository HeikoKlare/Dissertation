\section{Conservatively Approaching of the Orchestration Problem}
...
While this approach, in theory, allows to explore the complete problem space $P = \transformationset{T}^{< \mathbb{N}}$, it is impractical because the problem space is infinitely large.
