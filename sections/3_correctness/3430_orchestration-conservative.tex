...
In the following, we propose design goals for a conservative application algorithm and the algorithm itself and finally prove its correctness and termination properties.
...
\todo{Propose Provenance and Reactions Strategy.}
