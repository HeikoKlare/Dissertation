...
We investigated different orchestration strategies, such as the depth-first or breadth-first selection of transformations in the induced graph, and analyzed them with a simulator we developed for that purpose, which is available at GitHub~\cite{gleitze2020OrchestrationSimulator}.
