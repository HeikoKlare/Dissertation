...
\begin{align*}
    ...
    = \frac{
        ...
        \abs{\setted{\tupled{\modeltuple{m},\changetuple{\metamodeltuple{M}}} \mid \mathtextspacearound{consistent orchestration of} \transformationset{T} \mathtextspacearound{exists for} \tupled{\modeltuple{m}, \changetuple{\metamodeltuple{M}}}}}
    }
\end{align*}
