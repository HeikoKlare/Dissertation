...
\mnote{Avoiding mistakes by specific network topologies}
In \autoref{chap:topologies}, we will discuss how network topologies affect how prone a transformation network is to the possibility of containing faults.
