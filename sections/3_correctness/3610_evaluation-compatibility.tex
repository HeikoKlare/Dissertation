...
\begin{table}
    ...
    \begin{tabular}{L{0.7cm} L{7.1cm} C{2.0cm}}
        ...
        \bottomrule
    \end{tabular}
    \caption[Example scenarios with compatibility classification]{Example scenarios of consistency relations and their compatibility. Taken from \owncite[Table 3]{klare2020compatibility-report}.}
    \label{tab:correctness_evaluation:compatibility_scenarios}
\end{table}

\mnote{Scenarios of QVT-R transformations}
We have applied our prototypical implementation in a case study to $19$ scenarios.
...
\begin{table}
    ...
    \begin{tabular}{L{2cm} C{3.5cm} C{2.3cm}}
        \toprule
         ...
         \bottomrule
    \end{tabular}
    \caption[Correctness of compatibility classification results]{Compatibility classification of scenarios from \autoref{tab:correctness_evaluation:compatibility_scenarios} by our approach. Corrected from \owncite[Table 4]{klare2020compatibility-report}.}
