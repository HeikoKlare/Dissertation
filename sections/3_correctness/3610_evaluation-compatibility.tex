...
\begin{table}
    ...
    \begin{tabular}{L{0.7cm} L{7.1cm} C{2.0cm}}
        ...
        \bottomrule
    \end{tabular}
    \caption[Example scenarios with compatibility classification]{Example scenarios of consistency relations and their compatibility. Taken from~\owncite[Tab.~3]{klare2020compatibility-report}.}
