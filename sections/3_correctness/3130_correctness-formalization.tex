...
\todo{Move this to foundations}
Since it eases comprehension of the definitions if the considered models are identifiable with an index, we will consider, without loss of generality, tuples rather than set of models throughout the rest of this thesis.
