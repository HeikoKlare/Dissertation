...
\begin{definition}[Consistency to Transformation]
    ...
    \begin{align*}
        \modeltuple{m} \consistenttomath \transformationset{T} \equivalentperdefinition \forall \transformation{t} \in \transforamtionset{T} : $\modeltuple{m} \consistenttomath \transformation{t}$.
    \end{align*}
\end{definition}
