...
We did, however, find in \cite{saglam2020ma} that the distinction regarding elements does not bring any benefits when tracing the failures back to the causal mistakes.
