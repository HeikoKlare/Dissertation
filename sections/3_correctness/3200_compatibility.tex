...
We have defined in \autoref{chap:correctness} that transformations are composed of consistency relations and consistency preservation rules that preserve them.
...
Intuitively, these consistency relations are \emph{compatible}, as they lead to a reasonable tuple of models that are considered consistent to each other.
