...
In consequence, allowing such a model does not provide any benefits and thus should in the best case not occur, as there is no reason to create it but it may prevent transformations from finding consistent states.
...
This is why our coming formalization will base on a more fine-grained notion.

From these insights, we formulate the following, for now informal notion of compatibililty:
\begin{quote}
