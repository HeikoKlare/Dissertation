...
Problem statement: \todo{define problem statement}
...
\todo{Refer to the example in \autoref{chap:networks:example} and add the additional contradictory relation to explain the problem.}
