...
Finally, we have introduced a fine-grained consistency notion~\owncite{klare2020compatibility-report}, which is required for detailed statements on compatibility.
