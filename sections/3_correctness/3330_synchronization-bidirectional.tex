...
\begin{algorithm}
    \begin{algorithmic}[1]
        \Procedure{\function{Execute-Bidirectional-Transformation}}{$\transformation{T} = \tupled{\consistencyrelationset{CR}, \consistencypreservationrule{\consistencyrelationset{CR}}^{\rightarrow}, \consistencypreservationrule{\consistencyrelationset{CR}}^{\leftarrow}}, \model{m}{1}, \model{m}{2}, \change{\metamodel{M}{1}}$}
...
\begin{theorem}[Expressiveness of Synchronizing Bidirectional Transformation]
...
\begin{proof}
    ...
    \begin{align*}
        \function{Execute-Synchronizing-Bidirectional-Transformation}(\transformation{T}, \model{m}{1}, \model{m}{2}, \change{\metamodel{M}{2}}) = (\model{m}{1}', \model{m}{2}')
    \end{align*}
