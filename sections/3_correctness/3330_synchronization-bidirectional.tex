...
The execution of a bidirectional transformation then consists of the consecutive application of execution steps until the delivered models are consistent, as defined in \autoref{synchronization:executebidirectionaltransformation}.
...
\begin{theorem}{Bidirectional Transformation Execution Consistency}
    \label{theorem:bidirectionaltransformationconsistency}
...
\begin{proof}
    ...
    \autoref{algo:synchronization:executebidirectionaltransformation:line:returnbot} returns $\bot$, which fulfills the theorem statement.
...
\begin{theorem}[Consistency Termination of Partial-Consistency-Improving Synchronizing Bidirectional Transformation Execution]
...
\todo{Show equivalence of synchronizing transformation and synchronizing bidirectional transformation}
