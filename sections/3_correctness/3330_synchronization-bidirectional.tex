...
This leads to \autoref{algo:synchronization:executesynchronizingbidirectionaltransformation} for the execution of a synchronizing bidirectional transformation.
...
This algorithm has the same properties as the one for the non-synchronizing case given in \autoref{algo:synchronization:executebidirectionaltransformation}.
