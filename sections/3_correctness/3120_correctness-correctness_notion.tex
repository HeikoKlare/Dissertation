...
We have discussed this correctness notion in more detail as correctness between a \emph{modularization level} and a \emph{global level} which we identified for consistency specifications in previous work~\owncite{klare2019icmt}.
