...
\begin{figure}
    ...
    \caption[Construction of a model tuple for a consistency relation tree]{Construction of a model with the condition element containing person \enquote{Alice Avid} of $\consistencyrelation{CR}{1}$ for a consistency relation tree according to relations in \autoref{fig:compatibility:tree_example}. Taken from \owncite{klare2020compatibility-report}.}
