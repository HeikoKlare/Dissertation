...
\begin{proof}
    ...
    \begin{properdescription}
        ...
        \item[$max_n(\model{m}{1},\model{m}{2},\model{m}{3}) < x-1 \Rightarrow \tupled{\model{m}{1},\model{m}{2},\model{m}{3}} \mathtextspacearound{not consistent to} \consistencyrelationset{CR}$:]
