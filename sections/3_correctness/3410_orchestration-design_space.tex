...
\subsection{The Orchestration Problem} %Expected Behavior} % Failure Cases} %When to Return $\bot$?}
\label{chap:orchestration:design_space:problem}
...
The problem to find a consistent orchestration whenever it is exists is the central subject of the following sections.
We will prove the decidability of that problem, discuss how we can make it decidable and propose strategies to deal with its undecidable.
