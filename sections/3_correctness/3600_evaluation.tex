...
In fact, the results summarized in \autoref{tab:correctness_evaluation:compatibility_results} show that we have a precision of 1, thus having no incompatible scenarios classified as compatible by error:
