...
\begin{definition}[Condition]
    ...
    \begin{align*}
        \formulaskip &
        \modeltuple{m} \mathtext{contains} \conditionelement{c}{} \equivalentperdefinition
...
\label{def:consistencyrelation}
    ...
    \begin{align*}
        \formulaskip & 
        \modeltuple{m} \mathtext{contains} \tupled{\conditionelement{c}{l}, \conditionelement{c}{r}} \equivalentperdefinition \modeltuple{m} \mathtext{contains} \conditionelement{c}{l} \land \modeltuple{m} \mathtext{contains} \conditionelement{c}{r}
    \end{align*}
...
\begin{definition}[Consistency] \label{def:consistency}
    ...
    % \end{align*}
     \begin{align*}
        \formulaskip
        & 
        \modeltuple{m} \mathtext{consistent to} \consistencyrelation{CR}{} \equivalentperdefinition \\
        & \formulaskip
    ...
    \begin{align*}
        \formulaskip &
        \modeltuple{m} \mathtext{consistent to} \consistencyrelationset{CR} \equivalentperdefinition %\\
        %& \formulaskip
        \forall \consistencyrelation{CR}{} \in \consistencyrelationset{CR} : \modeltuple{m} \mathtext{consistent to} \consistencyrelation{CR}{}
    \end{align*}
\end{definition}

\begin{figure}
    \centering
    \input{figures/correctness/compatibility/consistency_example.tex}
...
\begin{lemma} \label{lemma:consistencytransitiveclosure}
    ...
    \begin{align*}
        \formulaskip
        \modeltuple{m} \mathtext{consistent to} \consistencyrelationset{CR} \equivalent
        \modeltuple{m} \mathtext{consistent to} \transitiveclosure{\consistencyrelationset{CR}}
    \end{align*}
\end{lemma}
...
\begin{proof}
    ...
    \begin{align*}
        \formulaskip
        \modeltuple{m} \mathtext{consistent to} \transitiveclosure{\consistencyrelationset{CR}} \Rightarrow \modeltuple{m} \mathtext{consistent to} \consistencyrelationset{CR}
    \end{align*}
    ...
    \begin{align*}
        \formulaskip
        \modeltuple{m} \mathtext{consistent to} \consistencyrelationset{CR} \Rightarrow
        \modeltuple{m} \mathtext{consistent to} \transitiveclosure{\consistencyrelationset{CR}}
    \end{align*}
...
\begin{definition}[Compatibility] \label{def:compatibility}
    ...
    \begin{align*}
        ...
        & \formulaskip \formulaskip
        \modeltuple{m} \mathtext{contains} \conditionelement{c}{} \land \modeltuple{m} \mathtext{consistent to} \consistencyrelationset{CR}
...
\begin{proof}
    ...
    \begin{align}
        ...
        : \exists \modeltuple{m} \in \metamodeltupleinstanceset{M} : \\
        & \formulaskip \formulaskip
        \modeltuple{m} \mathtext{contains} \conditionelement{c'}{l} \land \modeltuple{m} \mathtext{consistent to} \consistencyrelationset{CR}
    \end{align}
    ...
    \begin{align}
        ...
        : \exists \modeltuple{m} \in \metamodeltupleinstanceset{M} : \\
        & \formulaskip \formulaskip
        \modeltuple{m} \mathtext{contains} \conditionelement{c'}{} \land \modeltuple{m} \mathtext{consistent to} \transitiveclosure{\consistencyrelationset{CR}}
    \end{align}
