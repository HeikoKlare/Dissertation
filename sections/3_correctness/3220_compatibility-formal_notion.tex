...
Although that behavior may not be intuitive, it does not violate the definition of compatibility, because for every object in the relations, a consistent model can be constructed.
...
According to the informal notion of incompatibility that we have motivated in the introduction with that example in \autoref{fig:compatibility:intuitive_incompatibility}, our formal definition of compatibility also considers these relations as incompatible, because it is not possible to create a resident with an uppercase name, such that the containing tuple of models is consistent.
