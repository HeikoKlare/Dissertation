...
A bidirectional transformation according to \autoref{def:bidirectionaltransforamtion} consists of two unidirectional consistency preservation rules.
...
Necessity for extension of BX ot make them synchronizing
