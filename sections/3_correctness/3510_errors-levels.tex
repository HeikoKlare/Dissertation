...
At the first level, we do only consider the knowledge that a transformation shall be used within a transformation network.
...
Rather declarative, usually bidirectional transformation languages already relieve the developer from specifying consistency preservation rules and lifts the abstraction to consistency rules, from which consistency preservation rules are automatically derived.
