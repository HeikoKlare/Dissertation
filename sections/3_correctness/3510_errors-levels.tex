...
\mnote{Available knowledge and abstraction induce conceptual specification levels}
...
\mnote{Knowledge requires for each level}
...
\mnote{Levels only for modular consistency notion}
...
\mnote{Formalism can ensure correctness regarding some levels}
...
\mnote{Automated correctness at \leveltransformation level}
...
\mnote{Few approaches for correctness at higher levels}
...
\mnote{Dependencies between correctness at different levels}
