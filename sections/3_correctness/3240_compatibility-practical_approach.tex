...
\begin{align*}
\formulaskip
&(\{\propdisplay{\mathvariable{firstname}}\}, \{\mathvariable{fstn}\}), (\{\propdisplay{\mathvariable{lastname}}\}, \{\mathvariable{lstn}\}),\\ &(\{\propdisplay{\mathvariable{income}}\}, \{\mathvariable{inc}\}), (\{\propdisplay{\mathvariable{name}}\}, \{\mathvariable{fstn}, \mathvariable{lstn}\}),\\ &(\{\propdisplay{\mathvariable{salary}}\}, \{\mathvariable{inc}\})
\end{align*}
After the execution of the algorithm, properties are merged as follows:
\begin{align*}
\formulaskip
&(\{\propdisplay{\mathvariable{firstname}}, \propdisplay{\mathvariable{lastname}}, \propdisplay{\mathvariable{name}}\}, \{\mathvariable{fstn}, \mathvariable{lstn}\}),\\
&(\{\propdisplay{\mathvariable{income}}, \propdisplay{\mathvariable{salary}}\}, \{\mathvariable{inc}\})
\end{align*}
...
\begin{align*}
    &\left[(\propdisplay{\small \mathvariable{Person}::\mathvariable{firstname}} = f1) \wedge (\propdisplay{\small \mathvariable{Person}::\mathvariable{lastname}} = l1)\right.\\
    &\left.\formulaskip \wedge (\propdisplay{\small \mathvariable{Resident}::\mathvariable{name}} = f1 + ``\text{\textvisiblespace}" + l1)\right]\\
    \wedge & \left[(\propdisplay{\small \mathvariable{Person}::\mathvariable{firstname}} = f2) \wedge (\propdisplay{\small \mathvariable{Person}::\mathvariable{lastname}} = l2)\right.\\
    &\left.\formulaskip \wedge (\propdisplay{\small \mathvariable{Employee}::\mathvariable{name}} = f2 + ``\text{\textvisiblespace}" + l2)\right]\\
    \Rightarrow & \left(\exists n : (\propdisplay{\small \mathvariable{Resident}::\mathvariable{name}} = n) \wedge (\propdisplay{\small \mathvariable{Employee}::\mathvariable{name}} = n)\right)
\end{align*}
