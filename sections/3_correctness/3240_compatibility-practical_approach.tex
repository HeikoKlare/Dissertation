...
\newcolumntype{a}{>{\columncolor{Gray}}p{0.29\textwidth}}
...
In the following, we first introduce the so called \emph{property graph}, which is the graph induced by consistency relations that brings the graph characterization of transformations at the level of class properties and predicates. Such a structure can be represented as a hypergraph with a labeling.
