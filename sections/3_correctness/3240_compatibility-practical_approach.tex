...
\begin{figure}
    ...
    \caption[Property graph for the running example]{Property graph for \qvtr example in \autoref{lst:compatibility:qvtr_running_example} based on relations in \autoref{fig:compatibility:three_persons_example_extended}. Constraints for the predicate functions are annotated in boxes. Adapted from~\owncite[Fig.~11]{klare2020compatibility-report}.}
