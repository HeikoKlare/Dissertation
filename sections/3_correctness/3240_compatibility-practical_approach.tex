...
We define such a predicate based on combinations of properties, selected from each metamodel, whic we introduce in the following.
...
An extensional elementwise comparison is thus generally impossible.
...
One such strategy is the transformation of OCL expressions into first-order logic and the reasoning about the resulting first-oder formulae~\cite{beckert2002ocltranslation, berardi2005umlreasoning}.
...
Objects, such as strings, flotas, sequences and so can be represented by theories of theorem provers.
...
We have defined a representation of consistency relations inc graphs and explained how they can be derived from \qvtr transformations.
