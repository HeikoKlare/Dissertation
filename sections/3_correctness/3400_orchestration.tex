...
We can distinguish two approaches to ensure that the orchestration function is optiomal, i.e., that it does always find an execution order that yields consistent models if it exists.
