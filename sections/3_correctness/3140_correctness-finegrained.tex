...
The definitions are based on those proposed in the work of \textcite[Section 2.3.2, 4.1.1]{kramer2017a} and \textowncite{klare2020Vitruv-JSS}.
...
We do, however, not explicitly consider such an explicit trace model in this formalism due to two reasons also discussed in previous work~\owncite{klare2020Vitruv-JSS}.
...
\begin{figure}
    ...
    \caption[Conceptual model for transformation networks]{A conceptual model for the terms and artifacts introduced for transformation networks and their relations. Adapted from~\owncite[Fig.~5]{klare2020Vitruv-JSS}.}
