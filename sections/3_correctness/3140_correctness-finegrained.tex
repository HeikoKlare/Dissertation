...
Additionally, we know that there are specific kinds of restrictions that can be encoded in \modellevelconsistencyrelations that cannot be expressed with fine-grained consistency relations.
