...
\mnote{Evaluation of usefulness}
...
\mnote{Controlled experiment for high evidence}
...
\mnote{Scenario-based discussion of usefulness}
...
\mnote{Two failing example scenarios}
...
Regarding the number transformations to consider for finding the fault, this means that at most three transformations need to be considered, as this is largest simple cycle of transformations containing an incompatibility in their consistency relations:
\begin{align*}
...
\mnote{General restriction of number of considered transformations}
...
\mnote{Transformation selection order improvement}
