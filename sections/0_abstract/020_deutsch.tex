\emph{In dieser Dissertation formalisieren und analysieren wir die Konsistenzerhaltung verschiedener Artefakte zur Beschreibung eines Softwaresystems durch die Kopplung von Transformationen zwischen diesen und unterstützen sie mit geeigneten Methoden.}
...
Die bisherige Forschung beschränkt sich auf Transformationen zur Konsistenz\-erhaltung zweier Modelle %~\cite{stevens2020BidirectionalTransformationLarge-SoSym} 
...
Wir definieren die Eigenschaft der Kompatibilität von Transformationen% ~\cite{klare2020compatibility-report}
...
Schlussendlich definieren wir das Orchestrierungsproblem zum Finden einer Orchestrierung, die zu konsistenten Modelle führt wann immer solch eine Orchestrierung existiert. %\cite{gleitze2021orchestration-FASE}.
