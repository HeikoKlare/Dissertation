...
Schlussendlich definieren wir das Orchestrierungsproblem zum Finden einer Orchestrierung, d.h. einer Ausführungsreihenfolge der Transformationen nach der die Modelle konsistent sind, wann immer solch eine Reihenfolge existiert. %\cite{gleitze2021orchestration-FASE}.
...
Daraus leiten wir mittels den bereits genannten Fallstudien ab, dass die meisten möglichen Fehler per Konstruktion mit den in dieser Arbeit vorgeschlagenen Ansätzen vermieden werden können.
