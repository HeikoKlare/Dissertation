\chapter{Specifying Consistency with Commonalities \pgsize{20 p.}}
...
%\modified{either because the developer does not know about multidirectional relations or due to cognitive limitations~\cite{stevens2017a},} %keep instances of two metamodels consistent 
...
%An approach of adding additional metamodels is also shortly discussed in \cite{stevens2017a}, but with the focus on definability of multiary relations rather than the optimization regarding certain challenges.
