...
The problem could also be considered as a term rewriting problem, in which models states may be encoded as terms which are modified by transformation encoded as reduction relation.
