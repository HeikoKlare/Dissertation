...
% First, we expect that it improves understandability of relations between metamodels, because common concepts are not encoded in transformations implicitly but modeled explicitly.
...
% networks have been identified by \textowncite{gleitze2017a} and \textowncite{klare2018docsym}.
% Two essential properties %, defined in~\owncite{klare2018docsym}, 
% are \emph{compatibility} and \emph{modularity}~\owncite{klare2018docsym}, which, unfortunately, contradict each other.
