...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/quality/improvement/benefit_comprehensibility.png}
    ...
    \label{fig:improvement:benefit_comprehensibility}
\end{figure}

\todo{Maybe remove, because only reasonable for language, not for approach?}
