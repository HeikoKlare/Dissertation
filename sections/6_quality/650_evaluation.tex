...
It especially especially requires the usage of all elements provided by the \commonalities language, in comparison to preliminary studies in which only specific elements of the language were required and used to achieved feasibility results~\owncite{klare2019models}.
...
Evaluation of specification effort, generalization
