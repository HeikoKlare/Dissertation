...
\begin{table}
    \begin{tabular}{p{8em} p{20em}}
        ...
        \question{Functionality} & How many model changes in a case study can be properly kept consistent? \\\addlinespace[\innerrowspacing]
        \metric & \metrictext{Ratio of successfull test cases} \\\addlinespace[\outerrowspacing]
        \question{Practicality} & How far is the assumption of defining a tree of \commonalities is achievable in practice? \\\addlinespace[\innerrowspacing]
        ...
        \question{Benefit} & How much more concise is the specification for a case study compared to a definition with direct transformations? \\\addlinespace[\innerrowspacing]
