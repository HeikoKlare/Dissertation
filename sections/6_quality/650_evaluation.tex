...
\begin{table}
	...
	\begin{tabular}{lrrrr}
		...
		\bottomrule
	\end{tabular}
	\caption[Lines of code in the consistency specifications for \acrshort{UML} and Java]{Lines of code in the consistency specifications for UML and Java ($\Delta$ is the difference from $CS_{{UML}\leftrightarrow{Java}}$ (covered) to OO). Adapted from~\owncite[Table 10.9]{hennig2020ma}.}
