...
The motivation, central concepts, design options and a proof-of-concept for the language have already been published~\owncite{klare2018docsym}.
An initial prototype of the language was developed in the Bachelor's thesis of \textcite{gleitze2017a} and extended for a case study evaluation in the Master's thesis of \textcite{hennig2020ma}.
...
\begin{figure}
    ...
    \caption[\commonalitieslanguage elements]{Class diagram with the essential elements of the \commonalitieslanguage and their relations. Elements that exist independent from the language are depicted in top row.}
