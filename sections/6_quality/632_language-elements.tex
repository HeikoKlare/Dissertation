...
\begin{figure}
    ...
    \caption[Conciseness of \commonalities in comparison to \acrshort{QVT-R}]{Example for consistency relations between classes and components expressed with \qvtr and the \commonalities approach.}
