...
\begin{figure}
    ...
    \caption[Conciseness of \commonalities in comparison to \qvtr]{Example for consistency relations between classes and components expressed with \qvtr and the \commonalities approach.}
