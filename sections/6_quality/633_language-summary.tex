...
While we have discussed the relevant elements of that language in more detail and explained them at examples with a concrete textual syntax that we have developed for our prototypical implementation in the \vitruv framework~\owncite{vitruvFrameworkGithub}, we refer to the \mappings language of \textcite{kramer2017a} for further details on its operationalization.
