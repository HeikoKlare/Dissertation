...
% In practice, keeping redundancies consistent is a task that is often performed manually~\owncite{sax2017survey, guissouma2018study}.
...
% Commonalities approach, based on thesis by \textowncite{gleitze2017a}:
% \begin{itemize}
