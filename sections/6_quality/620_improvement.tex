...
\todo{Grafik für die Zusammenhänge (entweder hier oder für Sprache): Ansatz/Sprache bekommt konkrete Metamodelle + Commonalities-Spezifikation als Eingabe, erzeugt daraus Konzeptmetamodelle und Transformationen, die dann zur Laufzeit ausgeführt werden und Konzeptmodelle und konkrete Modelle erzeugen.}
...
\begin{figure}
    ...
    \begin{minipage}[b]{0.49\columnwidth}
        \centering
        \input{figures/quality/commonalities/topologies_full.tex}
    ...
    \begin{minipage}[b]{0.49\columnwidth}
        \centering
        \input{figures/quality/commonalities/topologies_tree.tex}
        \vspace{1em}
        \subcaption{Tree}
