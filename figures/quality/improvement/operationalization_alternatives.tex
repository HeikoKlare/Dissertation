...
\newcommand{\scenariodistance}{7*\distance}
...
% \node[schematic conceptmetamodel, right=7*\distance of additional_concept.center, anchor=center] (generate_concept) {};
% \node[schematic metamodel, below left=1.5*\distance and 0.5+\distance of generate_concept.center, anchor=center] (generate_concrete1) {};
% \node[schematic metamodel, below right=1.5*\distance and 0.5+\distance of generate_concept.center, anchor=center] (generate_concrete2) {};
