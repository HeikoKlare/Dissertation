...
\draw[manifests relation] (component_component) .. controls ([yshift=-0.5em,xshift=-\hdistance]component_component.west) and ([yshift=2*\vdistance]java_class.north west) .. ([xshift=-0.5em]java_class.north) node[manifests relation, pos=0.25, above] {\manifestslabel};
