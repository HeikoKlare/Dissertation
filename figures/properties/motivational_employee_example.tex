...
\node[above=0.2em of personnel_employee.north] (personnel_label) {\emph{(1) Personnel Data}};
...
\node[above=0.2em of task_task.north] (task_label) {\emph{(2) Task Management}};
...
\node[above=0.2em of scheduling_upper_middle] (scheduling_label) {\emph{(3) Scheduling}};
