...
\draw[-latex, densely dashed] (developer) -- node[midway, fill=white, opacity=0.7, text opacity=1, font=\sffamily\footnotesize] {\producestext} (d2);
\draw[-latex, densely dashed] (developer) -- (d3);
\draw[-latex, densely dashed] (developer) -- node[above right=0.3em and -0.5em, font=\sffamily\footnotesize] {\triggerstext} (validation);
