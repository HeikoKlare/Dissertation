...
\node[draw, consistency process, font=\fontsize{2}{2.6}\selectfont, align=left, above right=1em and 1.2*\hdistance of s4.center, anchor=center, minimum height=2em, minimum width=1em] (validation_result) {
result:\\
...
\node[legendbg, minimum width=6.8em, minimum height=4em, left=2.2*\hdistance of developer.north, anchor=north west] (legend) {}; 
