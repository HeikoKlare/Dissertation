...
\begin{tikzpicture}[
	...
	\draw[consistency execution] (application_start) -- node[right=0.5em, pos=1, generalreltext, consistency execution] {\appliestext} (application_cross);
	...
	\draw[consistency execution, latex-, densely dashed] (network) -- node[below, pos=0.7, sloped, generalreltext, consistency execution] {\usestext} ($(application_start)!0.5!(application_cross)$);
