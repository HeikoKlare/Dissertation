...
% MMA
\node[uml box, text width=5em, align=center] (mma) [left=4em of td] {Source\\ Metamodel};
...
% MMB
\node[uml box, text width=5em, align=center] (mmb) [right=4em of td] {Target\\ Metamodel};
