...
\node[draw, developer artifact, inner sep=0.15em, align=left] (trans1) {
    \begin{lstlisting}[language=qvt, frame=none, numbers=none, backgroundcolor=\color{white}, linewidth=1.9em, basicstyle=\fontsize{2}{2.4}\selectfont\ttfamily]
rule R {
    from ...
    to ...
...
% Experts
\umlhuman{expert1}{}{above left=0.2em and 1.25*\hdistance of trans1.center, anchor=center}{}{0.4}
\umlhuman{expert2}{}{above left=0.2em and 1.25*\hdistance of trans2.center, anchor=center}{}{0.4}
\umlhuman{expert3}{}{above left=0.2em and 1.25*\hdistance of trans3.center, anchor=center}{}{0.4}
...
% Machine
\coordinate (machine) at ([xshift=1.75*\hdistance]combination);
