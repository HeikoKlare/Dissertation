...
\node[problem statement, below left=1.5em and 7.5em of context.south, anchor=north] (ps1) {\emph{Problem Statement 1:} \\ Correctness};
\node[problem statement, right=15em of ps1.north, anchor=north] (ps2) {\emph{Problem Statement 2:} \\ Quality Properties};
