...
\draw[latex-latex] (tree_pcm) |- (tree_uml);
\draw[latex-latex] (tree_uml) -| (tree_java);

\draw[latex-latex] (graph_pcm) |- (graph_uml);
\draw[latex-latex] (graph_uml) -| (graph_java);
\draw[latex-latex] (graph_pcm) -- (graph_java);
