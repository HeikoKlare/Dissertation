...
\newcommand{\network}[8][]{
    ...
    \draw[consistency relation, #7] (#2_m1_#3) -- (#2_m2_#3);
    \draw[consistency relation, #8] (#2_m1_#3) -- (#2_m3_#3);
}
...
% Execution
\draw[consistency execution, -latex] ([xshift=0.1*\hdistance, yshift=-0.1*\hdistance]ind_m1_1.south) -- node[left, align=center, consistency execution] {user\\ change} ([xshift=0.1*\hdistance, yshift=0.2*\hdistance]ind_m1_2.north);
\draw[consistency execution, -latex] ([xshift=0.45*\hdistance, yshift=-0.1*\hdistance]ind_m1_2.south) -- node[left=0.2em, consistency execution] {$\function{Cp}_{1,3}$} ([xshift=0.2*\hdistance, yshift=0*\hdistance]ind_m2_3.north);
\draw[consistency execution, -latex] ([xshift=0.55*\hdistance, yshift=-0.1*\hdistance]ind_m1_2.south) -- node[right=0.2em, consistency execution] {$\function{Cp}_{2,3}$} ([xshift=-0.4*\hdistance, yshift=0*\hdistance]ind_m2_4.north);

% CONSECUTIVE
% Models
\network[left=2.5*\hdistance of ind_m1_1.center, anchor=center]{cons}{1}{$\model{m}{1}$}{$\model{m}{2}$}{$\model{m}{3}$}{}{}
...
% Execution
\draw[consistency execution, -latex] ([xshift=0.1*\hdistance, yshift=-0.1*\hdistance]cons_m1_1.south) -- node[left, align=center, consistency execution] {user\\ change} ([xshift=0.1*\hdistance, yshift=0.2*\hdistance]cons_m1_2.north);
\draw[consistency execution, -latex] ([xshift=0.1*\hdistance, yshift=-0.1*\hdistance]cons_m1_2.south) -- node[left, consistency execution] {$\function{Cp}_{1,2}$} ([xshift=0.1*\hdistance, yshift=0.2*\hdistance]cons_m1_3.north);
\draw[consistency execution, -latex] ([xshift=0.1*\hdistance, yshift=-0.1*\hdistance]cons_m1_3.south) --  node[left, consistency execution] {$\function{Cp}_{2,3}$} ([xshift=0.1*\hdistance, yshift=0.2*\hdistance]cons_m1_4.north);
