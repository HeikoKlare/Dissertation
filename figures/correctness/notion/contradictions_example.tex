...
\node[right=0.1em of first_mm1.west, anchor=west] {$\metamodelinstanceset{M}{1}$};
...
\node[right=0.1em of first_mm2.west, anchor=west] {$\metamodelinstanceset{M}{2}$};
...
% METAMODELS 2
\node[metamodel, right=2.7*\metamodelsize of first_mm1.center, anchor=center] (second_mm1) {};
