...
\node[mmlabel, anchor=center] (pcm_label) at (pcm_label_coordinate) {\gls{PCM}};

\coordinate (uml_class_label_coordinate) at ([yshift=\labeldistance]uml_class.north);
\node[mmlabel, anchor=center] (uml_class_label) at (uml_class_label_coordinate) {\gls{UML} Class};
...
\node[mmlabel, anchor=center] (uml_comp_label) at (uml_comp_label_coordinate) {\gls{UML} Component};
