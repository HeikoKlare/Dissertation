...
\node[above=0.3em of failure_l1_anchor] {\textbf{\LevelTransformation Level Mistake} ($R_{PE}, R_{PR}, R_{ER}$)};
...
\node[above=0.3em of failure_l2_anchor] {\textbf{\LevelNetworkRelation Level Mistake} ($R_{PE}, R_{PR}, R_{ER}'$)};
...
\node[above=0.3em of failure_l3_anchor] {\textbf{\LevelNetworkRule Level Mistake} ($R_{PE}, R_{PR}', R_{ER}$)};
