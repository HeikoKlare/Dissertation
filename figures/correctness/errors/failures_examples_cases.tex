...
\umlobjectvarwidth[, below left=0.4*\classdistance and \classdistance+\classwidth of l1_employee.north, anchor=north] {l1_person}{}{
: Person}{
firstname="Alice"
lastname="Avid"
}{\objectwidth}

\umlobjectvarwidth[, above right=1em and 2*\classdistance+2*\classwidth of l1_person.center, anchor=south] {l1_resident}{}{
: Resident}{
name="Alice Avid"
}{\objectwidth}

\umlobjectvarwidth[, above right=0.5em and 2*\classdistance+2*\classwidth of l1_person.center, anchor=north] {l1_resident_duplicate}{}{
: Resident}{
name="Alice Avid"
}{\objectwidth}
...
% LEVEL 2 ERROR
\coordinate (failure_l2_anchor) at ([yshift=-0.75*\classdistance]l1_resident_duplicate.south-|failure_l1_anchor);
...
\umlobjectvarwidth[, below=0.7*\classdistance of l2_employee.north, anchor=north]{l2_employee2}{}{
: Employee}{
name="alice avid"
}{\objectwidth}

\umlobjectvarwidth[, below left=0.4*\classdistance and \classdistance+\classwidth of l2_employee.north, anchor=north] {l2_person}{}{
: Person}{
firstname="Alice"
lastname="Avid"
}{\objectwidth}

\umlobjectvarwidth[, below=0.9*\classdistance of l2_person.north, anchor=north]{l2_person2}{}{
: Person}{
firstname="alice"
lastname="avid"
}{\objectwidth}

\umlobjectvarwidth[, right=2*\classdistance+2*\classwidth of l2_person.center, anchor=center] {l2_resident}{}{
: Resident}{
name="alice avid"
}{\objectwidth}
...
% LEVEL 3 ERROR
\coordinate (failure_l3_anchor) at ([yshift=-0.75*\classdistance]l2_person2.south-|failure_l1_anchor);
...
\umlobjectvarwidth[, below=1.7*\classdistance of l3_employee.north, anchor=north]{l3_employee2}{}{
: Employee}{
name="Avid Alice"
}{\objectwidth}

\umlobjectvarwidth[, below left=0.5*\classdistance and \classdistance+\classwidth of l3_employee.north, anchor=north] {l3_person}{}{
: Person}{
firstname="Alice"
lastname="Avid"
}{\objectwidth}

\umlobjectvarwidth[, below=0.9*\classdistance of l3_person.north, anchor=north]{l3_person2}{}{
: Person}{
firstname="Avid"
lastname="Alice"
}{\objectwidth}

\umlobjectvarwidth[, right=2*\classdistance+2*\classwidth of l3_person.center, anchor=center] {l3_resident}{}{
: Resident}{
name="Alice Avid"
}{\objectwidth}

\umlobjectvarwidth[, below=0.7*\classdistance of l3_resident.north, anchor=north]{l3_resident2}{}{
: Resident}{
name="Avid Alice"
}{\objectwidth}
...
\draw[consistency preservation] (l3_resident2.south) |- ++(-5.3*\classdistance, -0.6*\classdistance) node[pos=0.6, above] {7. +} |- (l3_person.west);
