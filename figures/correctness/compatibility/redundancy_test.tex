...
\node (r2) at (12.5em,18em) [draw, darkgreen, thick, dashed, anchor=north west, minimum width=11em,minimum height=21em] {};
...
%% SMT SOLVER
\node[draw,rectangle, minimum width=4em, minimum height=3em, fill=darkblue!20, above right=9em and 1.25em+0.45*\difftoafiveimage of r2.east, anchor=west, align=center] (smtsolver) {SMT\\ Solver};
...
\node[right = 8.125em+0.45*\difftoafiveimage of smtf.center, anchor=center] {\textbf{Result}};
