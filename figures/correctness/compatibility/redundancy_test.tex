...
%% SMT SOLVER
\node[draw,rectangle, minimum width=4em, minimum height=3em, fill=darkblue!20, above right=9em and 1.25em of r2.east, anchor=west, align=center] (smtsolver) {SMT\\ Solver};
