...
\draw[consistency relation] (resident.west) -| node[pos=0, below left] {$r$} node[pos=0.25, below] {$R_{PR} / R'_{PR}$} node[pos=1, below left] {$p$} (person.south);
...
\node[consistency related element, below left=5em and 2.5em of person.south west, anchor=north west] {
$\begin{aligned}
    R_{PE} =\; &
