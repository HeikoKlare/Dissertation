...
\node[below right=0.45*\mmdistance and \mmdistance of graph_bottomleft.center, anchor=north, align=center] 
{ 
...
\node[mm, below=1.15*\mmdistance of tree1_middle.center, anchor=center] (tree2_middle) {$\metamodel{M}{1}$};
...
\node[above=0.45*\mmdistance of tree2_middle.center, anchor=center] {\Large\textbf{+}};
