...
\newcommand{\hdistance}{(\classwidth+2*\mmborder+1.9em+0.4*\difftoafiveimage)}
...
\umlclassvarwidth[, below=0.5*\vdistance of pcm1_ia.north, anchor=north]{pcm1_a}{}{\umlcomponentlabel\\ A}{
}{\classwidth}
\pcmprovidedrole{[xshift=1em]pcm1_a.north}{[xshift=1em]pcm1_ia.south}{left, stereotype}

\umlclassvarwidth[, below=1.3*\vdistance of pcm1_ia.north, anchor=north]{pcm2_ia}{}{\umlinterfacelabel\\ IA}{
    method()
}{\classwidth}
\umlclassvarwidth[, below=0.6*\vdistance of pcm2_ia.north, anchor=north]{pcm2_a}{}{\umlcomponentlabel\\ A}{
}{\classwidth}
\pcmprovidedrole{[xshift=1em]pcm2_a.north}{[xshift=1em]pcm2_ia.south}{left, stereotype}

% UML
\umlclassvarwidth[, right=\hdistance of pcm1_ia.north, anchor=north]{uml1_ia}{}{\umlinterfacelabel\\ IA}{
}{\classwidth}
\umlclassvarwidth[, below=0.5*\vdistance of uml1_ia.north, anchor=north]{uml1_a}{}{A}{
    method()
}{\classwidth}
\umlsubclassof{uml1_a}{--}{uml1_ia}

\umlclassvarwidth[, right=\hdistance of pcm2_ia.north, anchor=north]{uml2_ia}{}{\umlinterfacelabel\\ IA}{
    method()
}{\classwidth}
\umlclassvarwidth[, below=0.6*\vdistance of uml2_ia.north, anchor=north]{uml2_a}{}{A}{
}{\classwidth}
\umlsubclassof{uml2_a}{--}{uml2_ia}

% JAVA
\node[above right=0.0*\vdistance and 1.17*\hdistance of uml1_a.south, anchor=south, text width=9em, inner sep=0em] (java1_code) {
...
\node[above right=0.75em and 1.17*\hdistance of uml2_ia.north, anchor=north, text width=9em, inner sep=0em] (java2_code) {
\begin{lstlisting}[language=java, numbers=none, backgroundcolor=\color{white}, basicstyle=\footnotesize\ttfamily]
interface IA {
    void method();
}
