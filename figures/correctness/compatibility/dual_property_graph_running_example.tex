\begin{tikzpicture}[every node/.style={font=\small, inner sep=0.2em}]
    %% GRAPH NODES
    \node[circle, fill=darkgreen!20, draw=darkgreen, name=greenN] at (20em, 4.5em) {};
    \node[circle, fill=darkorange!20, draw=darkorange, name=orangeN] at (0, 3em) {};
    \node[circle, fill=darkred!20, draw=darkred, name=yellowN] at (10em, -3em) {};

    \node[circle, fill=darkblue!20, draw=darkblue, name=salary] at (-1em, -3em) {};
    
    \node[circle, fill=darkblue!20, draw=darkblue, name=socsecnumber] at (-3em, 0) {};
    
    \node[circle, fill=darkblue!20, draw=darkblue, name=address] at (20em, -1.5em) {};
