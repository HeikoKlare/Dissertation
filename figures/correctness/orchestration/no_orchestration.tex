...
\umlclassvarwidth[, below right=0.4*\vdistance and 0.5*\hdistance of person.north, anchor=north]{employee}{}{Employee}{
name
}{\classwidth}
...
\draw[transformation, -latex] 
    ([xshift=-0.7em]person.south)
    |-
    node[below left=0.5em and 2.3em+0.25*\difftoafiveimage, pos=0.5, anchor=north west, align=center] {
        $\begin{aligned}
            +p \rightarrow +e(
            &
...
\draw[transformation, latex-]
    ([xshift=0.7em]resident.south)
    |-
    node[below right=0.5em and 2.3em-0.25*\difftoafiveimage, pos=0.5, anchor=north east, align=center] {
