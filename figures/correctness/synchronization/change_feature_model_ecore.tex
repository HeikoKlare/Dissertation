...
\node [yshift=-6ex,xshift=-23ex,anchor=north west] (leg) at (!12211) {\textbf{Constraints:}};
...
\node [right=40ex of leg1.north west, anchor=north west] (leg4) {4.\ Existential $\Rightarrow$ (Root $\oplus$ Reference)};
