...
\filldraw[consistency execution] (cross_one) circle (0.15em);
\node[consistency execution, above=0.5em of cross_one] {$\consistencypreservationrule{\consistencyrelationset{CR}}^{\rightarrow}$};
...
\filldraw[consistency execution] (cross_two) circle (0.15em);
...
\draw[consistency execution, -] 
    ...
    -- (cross_two);
\draw[consistency execution, -latex] (cross_two) -- ([xshift=0.2em]dd1);
