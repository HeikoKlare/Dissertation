...
\draw[darkblue, thick] (0,0) ellipse (15em and 15em);
\node[darkblue, anchor=north, align=center, font=\footnotesize\bfseries] at (0, 14em) {\emph{Goal:}\\ Consistency and its Preservation};
\draw[darkblue, thick] (3em,-0.25em) ellipse (11.5em and 11.5em);
\node[darkblue, anchor=north, align=center, font=\footnotesize\bfseries] at (3em, 10.25em) {\emph{Methodology:}\\ Consistency by Transformation};
